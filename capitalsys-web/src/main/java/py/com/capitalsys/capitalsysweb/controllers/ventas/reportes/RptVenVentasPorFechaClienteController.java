package py.com.capitalsys.capitalsysweb.controllers.ventas.reportes;
...
@ManagedBean
@ViewScoped
public class RptVenVentasPorFechaClienteController {
	...
	public ParametrosReporte getParametrosReporte() {
		if (Objects.isNull(parametrosReporte)) {
			...
			parametrosReporte.setReporte("VenVentasPorFecha");
		}
