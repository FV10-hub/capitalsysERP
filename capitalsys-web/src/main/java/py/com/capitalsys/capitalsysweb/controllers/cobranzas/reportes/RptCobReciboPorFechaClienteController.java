package py.com.capitalsys.capitalsysweb.controllers.cobranzas.reportes;
...
@ManagedBean
@ViewScoped
public class RptCobReciboPorFechaClienteController {
	...
	public ParametrosReporte getParametrosReporte() {
		if (Objects.isNull(parametrosReporte)) {
			...
			parametrosReporte.setReporte("CobRecibosPorFecha");
		}
