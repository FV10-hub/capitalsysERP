...
public class GuestPreferences implements Serializable {
	 ...
	 * la documentacion para elegir los colores
	 * https://www.primefaces.org/pandora/documentation.xhtml
	 * */
	//cyan
	private String layoutPrimaryColor = "magenta";
	// cyan
	private String topbarTheme = "magenta";
	// bluegrey
	private String componentTheme = "magenta";

	private String menuMode = "layout-static";
	// light
	private String menuColor = "dark";
	// teallight
	private String menuTheme = "magenta";
	//outlined
	private String inputStyle = "failed";
	...
	public void init() {
		...
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("blue", "#2E88FF"),
				new Color("blue", "#2E88FF"), new Color("blue", "#2E88FF")));

		/* Menu: Dark | Active: Blue | Topbar: Blue | Components: Blue-Grey */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("blue", "#2E88FF"),
				new Color("blue", "#2E88FF"), new Color("bluegrey", "#607D8B")));

		/*
		 * Menu: Light | Active: Teal-Light | Topbar: Teal-Light | Components:
		 * Teal-Light
		 */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("teallight", "#21B5AD"),
				new Color("teallight", "#21B5AD"), new Color("teallight", "#21B5AD")));

		/*
		 * Menu: Dark | Active: Teal-Light | Topbar: Teal-Light | Components: Blue-Grey
		 */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("teallight", "#21B5AD"),
				new Color("teallight", "#21B5AD"), new Color("bluegrey", "#607D8B")));

		/* Menu: Dark | Active: Purple | Topbar: Purple | Components: Purple */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("purple", "#636FC0"),
				new Color("purple", "#636FC0"), new Color("purple", "#636FC0")));

		/* Menu: Light | Active: Orange | Topbar: Purple | Components: Orange */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("orange", "#EC7A51"),
				new Color("purple", "#636FC0"), new Color("orange", "#EC7A51")));

		/* Menu: Dark | Active: Magenta | Topbar: Magenta | Components: Magenta */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("magenta", "#C03995"),
				new Color("magenta", "#C03995"), new Color("magenta", "#C03995")));

		/* Menu: Light | Active: Cyan | Topbar: Magenta | Components: Cyan */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("cyan", "#2199B5"),
				new Color("magenta", "#C03995"), new Color("cyan", "#2199B5")));

		/* Menu: Dark | Active: Yellow | Topbar: Yellow | Components: Yellow */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("yellow", "#F3A841"),
				new Color("yellow", "#F3A841"), new Color("yellow", "#F3A841")));

		/* Menu: Light | Active: Yellow | Topbar: Yellow | Components: Blue-Grey */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("yellow", "#F3A841"),
				new Color("yellow", "#F3A841"), new Color("bluegrey", "#607D8B")));

		/* Menu: Dark | Active: Green | Topbar: Green | Components: Green */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("green", "#21B567"),
				new Color("green", "#21B567"), new Color("green", "#21B567")));

		/* Menu: Light | Active: Green | Topbar: Green | Components: Yellow */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("green", "#21B567"),
				new Color("green", "#21B567"), new Color("yellow", "#F3A841")));

		/* Menu: Dark | Active: Cyan | Topbar: Cyan | Components: Cyan */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("cyan", "#2199B5"),
				new Color("cyan", "#2199B5"), new Color("cyan", "#2199B5")));

		/* Menu: Light | Active: Cyan | Topbar: Cyan | Components: Yellow */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("cyan", "#2199B5"),
				new Color("cyan", "#2199B5"), new Color("yellow", "#F3A841")));

		/*
		 * Menu: Dark | Active: Purple-Light | Topbar: Purple-Light | Components:
		 * Purple-Light
		 */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("purplelight", "#9754B8"),
				new Color("purplelight", "#9754B8"), new Color("purplelight", "#9754B8")));

		/*
		 * Menu: Light | Active: Purple-Light | Topbar: Purple-Light | Components:
		 * Purple-Light
		 */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("purplelight", "#9754B8"),
				new Color("purplelight", "#9754B8"), new Color("purplelight", "#9754B8")));

		/* Menu: Dark | Active: Orange | Topbar: Orange | Components: Orange */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("orange", "#EC7A51"),
				new Color("orange", "#EC7A51"), new Color("orange", "#EC7A51")));

		/* Menu: Light | Active: Orange | Topbar: Orange | Components: Yellow */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("orange", "#EC7A51"),
				new Color("orange", "#EC7A51"), new Color("yellow", "#F3A841")));

		/* Menu: Dark | Active: Red | Topbar: Red | Components: Red */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("red", "#FE566D"), new Color("red", "#FE566D"),
				new Color("red", "#FE566D")));

		/* Menu: Light | Active: Red | Topbar: Red | Components: Blue-Grey */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("red", "#FE566D"),
				new Color("red", "#FE566D"), new Color("bluegrey", "#607D8B")));

		/*
		 * Menu: Dark | Active: Teal-Dark | Topbar: Teal-Dark | Components: Teal-Light
		 */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("tealdark", "#076D72"),
				new Color("tealdark", "#076D72"), new Color("teallight", "#21B5AD")));

		/*
		 * Menu: Light | Active: Teal-Dark | Topbar: Teal-Dark | Components: Teal-Dark
		 */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("tealdark", "#076D72"),
				new Color("tealdark", "#076D72"), new Color("tealdark", "#076D72")));

		/*
		 * Menu: Dark | Active: Purple-Dark | Topbar: Purple-Dark | Components:
		 * Purple-Dark
		 */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("purpledark", "#44358F"),
				new Color("purpledark", "#44358F"), new Color("purpledark", "#44358F")));

		/*
		 * Menu: Light | Active: Purple-Dark | Topbar: Purple-Dark | Components:
		 * Purple-Light
		 */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("purpledark", "#44358F"),
				new Color("purpledark", "#44358F"), new Color("purplelight", "#9754B8")));

		/* Menu: Light | Active: Indigo | Topbar: Indigo | Components: Magenta */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("indigo", "#303498"),
				new Color("indigo", "#303498"), new Color("magenta", "#C03995")));

		/* Menu: Dark | Active: Indigo | Topbar: Indigo | Components: Indigo */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("indigo", "#303498"),
				new Color("indigo", "#303498"), new Color("indigo", "#303498")));

		/* Menu: Light | Active: Cyan | Topbar: Seagreen | Components: Cyan */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("cyan", "#2199B5"),
				new Color("seagreen", "#354045"), new Color("cyan", "#2199B5")));

		/* Menu: Light | Active: Orange | Topbar: Seagreen | Components: Orange */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("orange", "#EC7A51"),
				new Color("seagreen", "#354045"), new Color("orange", "#EC7A51")));

		/*
		 * Menu: Light | Active: Teal-Light | Topbar: Seagreen | Components: Teal-Light
		 */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("teallight", "#21B5AD"),
				new Color("seagreen", "#354045"), new Color("teallight", "#21B5AD")));

		/* Menu: Dark | Active: Blue | Topbar: Dark | Components: Blue */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("blue", "#2E88FF"),
				new Color("dark", "#252729"), new Color("blue", "#2E88FF")));

		/* Menu: Light | Active: Purple | Topbar: Dark | Components: Purple */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("purple", "#636FC0"),
				new Color("dark", "#252729"), new Color("purple", "#636FC0")));

		/* Menu: Dark | Active: Green | Topbar: Dark | Components: Green */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("green", "#21B567"),
				new Color("dark", "#252729"), new Color("green", "#21B567")));

		/* Menu: Light | Active: Cyan | Topbar: Dark | Components: Cyan */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("cyan", "#2199B5"),
				new Color("dark", "#252729"), new Color("cyan", "#2199B5")));

		/* Menu: Dark | Active: Orange | Topbar: Dark | Components: Orange */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("orange", "#EC7A51"),
				new Color("dark", "#252729"), new Color("orange", "#EC7A51")));

		/* Menu: Light | Active: Indigo | Topbar: Dark | Components: Indigo */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("indigo", "#303498"),
				new Color("dark", "#252729"), new Color("indigo", "#303498")));

		/* Menu: Light | Active: Cyan | Topbar: Light | Components: Blue-Grey */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("cyan", "#2199B5"),
				new Color("light", "#f8fafc"), new Color("bluegrey", "#607D8B")));

		/* Menu: Light | Active: Teal-Light | Topbar: Light | Components: Teal-Light */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("teallight", "#21B5AD"),
				new Color("light", "#f8fafc"), new Color("teallight", "#21B5AD")));

		/* Menu: Light | Active: Purple | Topbar: Light | Components: Purple */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("purple", "#636FC0"),
				new Color("light", "#f8fafc"), new Color("purple", "#636FC0")));

		/* Menu: Light | Active: Cyan | Topbar: Light | Components: Cyan */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("cyan", "#2199B5"),
				new Color("light", "#f8fafc"), new Color("cyan", "#2199B5")));

		/* Menu: Dark | Active: Orange | Topbar: Light | Components: Orange */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("orange", "#EC7A51"),
				new Color("light", "#f8fafc"), new Color("orange", "#EC7A51")));

		/* Menu: Light | Active: Teal-Dark | Topbar: Light | Components: Teal-Dark */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("tealdark", "#076D72"),
				new Color("light", "#f8fafc"), new Color("tealdark", "#076D72")));

		/* Menu: Dark | Active: Indigo | Topbar: Light | Components: Indigo */
		palettes.add(new Palette(new Color("dark", "#252729"), new Color("indigo", "#303498"),
				new Color("light", "#f8fafc"), new Color("indigo", "#303498")));

		/* Menu: Light | Active: Indigo | Topbar: Blue-Dark | Components: Indigo */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("indigo", "#303498"),
				new Color("bluedark", "#232946"), new Color("indigo", "#303498")));

		/* Menu: Light | Active: Magenta | Topbar: Blue-Dark | Components: Magenta */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("magenta", "#C03995"),
				new Color("bluedark", "#232946"), new Color("magenta", "#C03995")));

		/*
		 * Menu: Light | Active: Purple-Light | Topbar: Blue-Dark | Components:
		 * Purple-Light
		 */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("purplelight", "#9754B8"),
				new Color("bluedark", "#232946"), new Color("purplelight", "#9754B8")));

		/* Menu: Light | Active: Yellow | Topbar: Grey | Components: Blue-Grey */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("yellow", "#F3A841"),
				new Color("gray", "#525557"), new Color("bluegrey", "#607D8B")));

		/* Menu: Light | Active: Teal-Light | Topbar: Grey | Components: Teal-Light */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("teallight", "#21B5AD"),
				new Color("gray", "#525557"), new Color("teallight", "#21B5AD")));

		/* Menu: Light | Active: Magenta | Topbar: Greylight | Components: Magenta */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("magenta", "#21B5AD"),
				new Color("graylight", "#8B8E90"), new Color("magenta", "#C03995")));

		/* Menu: Light | Active: Magenta | Topbar: Greylight | Components: Yellow */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("magenta", "#21B5AD"),
				new Color("graylight", "#8B8E90"), new Color("yellow", "#F3A841")));

		/*
		 * Menu: Blue-Dark | Active: Blue-Dark | Topbar: Blue-Dark | Components: Purple
		 * Light
		 */
		palettes.add(new Palette(new Color("colored", "#232946"), new Color("bluedark", "#232946"),
				new Color("bluedark", "#232946"), new Color("purple", "#636FC0")));

		/*
		 * Menu: Blue-Dark | Active: Blue-Dark | Topbar: Blue-Dark | Components: Yellow
		 */
		palettes.add(new Palette(new Color("colored", "#232946"), new Color("bluedark", "#232946"),
				new Color("bluedark", "#232946"), new Color("yellow", "#F3A841")));

		/*
		 * Menu: Blue-Dark | Active: Blue-Dark | Topbar: Blue-Dark | Components:
		 * Purple-Light
		 */
		palettes.add(new Palette(new Color("colored", "#232946"), new Color("bluedark", "#232946"),
				new Color("bluedark", "#232946"), new Color("purplelight", "#9754B8")));
		 ...
		 */
		palettes.add(new Palette(new Color("colored", "#232946"), new Color("bluedark", "#232946"),
				new Color("bluedark", "#232946"), new Color("orange", "#EC7A51")));
		...
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("teallight", "#21B5AD"),
				new Color("tealdark", "#076D72"), new Color("bluegrey", "#607D8B")));
		...
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("teallight", "#21B5AD"),
				new Color("tealdark", "#076D72"), new Color("yellow", "#F3A841")));

		/* Menu: Light | Active: Teallight | Topbar: Tealdark | Components: Orange */
		palettes.add(new Palette(new Color("light", "#f8fafc"), new Color("teallight", "#21B5AD"),
				new Color("tealdark", "#076D72"), new Color("orange", "#EC7A51")));
		...
		palettes.add(new Palette(new Color("colored", "#2E88FF"), new Color("blue", "#2E88FF"),
				new Color("light", "#f8fafc"), new Color("blue", "#2E88FF")));

		/* Menu: Purple | Active: Purple | Topbar: Purple | Components: Purple */
		palettes.add(new Palette(new Color("colored", "#636FC0"), new Color("purple", "#636FC0"),
				new Color("purple", "#636FC0"), new Color("purple", "#636FC0")));
		...
		palettes.add(new Palette(new Color("colored", "#C03995"), new Color("magenta", "#C03995"),
				new Color("magenta", "#C03995"), new Color("magenta", "#C03995")));

		/* Menu: Magenta | Active: Magenta | Topbar: Dark | Components: Blue-Grey */
		palettes.add(new Palette(new Color("colored", "#C03995"), new Color("magenta", "#C03995"),
				new Color("dark", "#252729"), new Color("bluegrey", "#607D8B")));

		/* Menu: Magenta | Active: Magenta | Topbar: Light | Components: Purple-Light */
		palettes.add(new Palette(new Color("colored", "#C03995"), new Color("magenta", "#C03995"),
				new Color("light", "#f8fafc"), new Color("purplelight", "#9754B8")));

		/* Menu: Cyan | Active: Cyan | Topbar: Cyan | Components: Cyan */
		palettes.add(new Palette(new Color("colored", "#2199B5"), new Color("cyan", "#2199B5"),
				new Color("cyan", "#2199B5"), new Color("cyan", "#2199B5")));
		...
		palettes.add(new Palette(new Color("colored", "#2199B5"), new Color("cyan", "#2199B5"),
				new Color("seagreen", "#354045"), new Color("bluegrey", "#607D8B")));

		/* Menu: Yellow | Active: Yellow | Topbar: Dark | Components: Yellow */
		palettes.add(new Palette(new Color("colored", "#F3A841"), new Color("yellow", "#F3A841"),
				new Color("dark", "#252729"), new Color("yellow", "#F3A841")));
		...
		palettes.add(new Palette(new Color("colored", "#21B567"), new Color("green", "#21B567"),
				new Color("green", "#21B567"), new Color("green", "#21B567")));
		...
		palettes.add(new Palette(new Color("colored", "#21B567"), new Color("green", "#21B567"),
				new Color("light", "#f8fafc"), new Color("yellow", "#F3A841")));

		/*
		 * Menu: Purple-Light | Active: Purple-Light | Topbar: Purple-Light |
		 * Components: Purple-Light
		 */
		palettes.add(new Palette(new Color("colored", "#9754B8"), new Color("purplelight", "#9754B8"),
				new Color("purplelight", "#9754B8"), new Color("purplelight", "#9754B8")));

		/*
		 * Menu: Purple-Light | Active: Purple-Light | Topbar: Light | Components:
		 * Blue-Grey
		 */
		palettes.add(new Palette(new Color("colored", "#9754B8"), new Color("purplelight", "#9754B8"),
				new Color("light", "#f8fafc"), new Color("bluegrey", "#607D8B")));
		...
		palettes.add(new Palette(new Color("colored", "#EC7A51"), new Color("orange", "#EC7A51"),
				new Color("dark", "#252729"), new Color("orange", "#EC7A51")));
		...
		palettes.add(new Palette(new Color("colored", "#FE566D"), new Color("red", "#FE566D"),
				new Color("dark", "#252729"), new Color("red", "#FE566D")));
		...
		palettes.add(new Palette(new Color("colored", "#303498"), new Color("indigo", "#303498"),
				new Color("indigo", "#303498"), new Color("indigo", "#303498")));
	...
	public String getLayoutConfig() {
		...
		String menuModeClass = this.menuMode.equals("layout-static") ? "layout-static layout-static-active"
				: this.menuMode;
